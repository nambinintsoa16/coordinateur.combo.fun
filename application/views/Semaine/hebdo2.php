<div class="form-group">
    ...
    <div class="center text-center">
        Chiffre d'affaires livré hebdomadaire
    </div>
    ...
    <table class="table table-striped table-hover table-bordered table-responsive">
        ...
        <thead class="thead-light">
            ...
            ?>
            <tr>
                <th class="bg-warning" style="font-size:12px">OPLG</th>
                <th class="bg-warning" style="font-size:12px">MATRICULE</th>
                <th class="bg-warning texte-center" style="font-size:12px">
                    <? echo $date5 ?>
                </th>
                <th class="bg-warning texte-center" style="font-size:12px">
                    <? echo $date4 ?>
                ...
                <th class="bg-warning texte-center" style="font-size:12px">CA_DU_JOUR</th>
            </tr>
