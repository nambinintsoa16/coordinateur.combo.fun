<fieldset class="border">
    <legend class="w-auto"><b class="text-sm">VENTE LIVREE</b></legend>
...
<div class="table-responsive-lg">
    <table class="table table_report table-striped table-hover table-bordered">

        <thead>
            <tr style="font-size:9px;background-color:#40C4FF" class="casema">
                <th>TOTAL</th>
