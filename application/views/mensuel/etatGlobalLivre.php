<div class="container col-md-12">
    <fieldset class="border p-1">
        <legend class="w-auto"><b class="text-sm">Etat global mensuel livré</b></legend>
            <!-- <div class=" col-md-12">
        ...
        <table class="table table-bordered table-bordered-bd-secondary tableGlobales table-stripted table-hover tableResult table-bordered table-striped">
                ...
                <tr class="bg-secondary text-white">
                 ...
                 <tr class="bg-primary text-white">                    
                    ...
                    <?php foreach ($jours as $key): ?> 
                        <?php $facture = $this->accueil_model->etatGlobalLivresJour($key->Date);
                        $caprevi=0;
            ...
            <!-- <?php foreach ($oplg as $value): ?>                  
                <tr>                         
                    ...
                    <td  class="tbody text-center"><?= strtoupper($value->Prenom)?></td>    
                    <?php foreach ($jours as $key): ?> 

                        <?php $facture = $this->accueil_model->etatGlobalLivres($key->Date, $value->Matricule_personnel);
                        $caprevi=0;
                            foreach ($facture as $facture) {
                                $caprevi += ($facture->Quantite * $facture->Prix_detail);
                            }?>
