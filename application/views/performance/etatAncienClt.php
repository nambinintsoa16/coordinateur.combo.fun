		...
		<div class="page-inner mt-3">
			<div class="row">
                <form class="col-md-12">
                    ...
                    <legend class="w-auto"><b class="text-sm">Etat discussion anciens clients</b><span id="date_content"><?=date('d-m-Y')?></span></b></legend>  
						<div class="row">
                        <div class="col-md-8">
                        ...
                        <table class="table table-striped table-bordered-bd-secondary table-responsive-lg table-hover tableResult table-head-bg-secondary">
                            <thead>
                                ...
                                <tr class="bg-primary">
                                    ...
                                    <th class="text-sm text-center"></th>
                                    <th class="text-sm text-center"><?=$result?></th>
