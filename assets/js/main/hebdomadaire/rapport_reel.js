$(document).ready(function() {
   ...
   /* $(".result").on('click', function(e) {
        ...
        $.post(base_url + 'Hebdomadaire/detailParMatriculeReel', {codeOplg:codeOplg }, function(data) {
    ...
    $('.result_reel').on('click', function(e){
    e.preventDefault();
    //$('.matricule_opl').empty().append(localStorage.getItem('matricule'));
    var matricule = $(this).text();    
    var link = base_url + "Hebdomadaire/detailParMatriculeR?matricule=" + matricule;
    Table.ajax.url(link);
    Table.ajax.reload();
   ...
   $(".tbody td>a").on('click', function(e) {
        ...
        $.post(base_url + 'Hebdomadaire/produitReel', { date: date, Matricule_personnel: Matricule_personnel }, function(data) {
    ...
    $(".totalHebdo").on('click', function(e) {
        e.preventDefault();
        loding();
        $.post(base_url + 'Hebdomadaire/TotalproduitReels', { }, function(data) {
    ...
    $(".produit").on('click', function(e) {
        ...
        $.post(base_url + 'Hebdomadaire/TotalproduitReel',{matricule : matricule }, function(data) {
    ...
    $(".thead th>a").on('click', function(e) {
        ...
        var index = $(this).parent().index();
        var date = $(".dataClass th").eq(index).text().trim();
        $.post(base_url + 'Hebdomadaire/totalporeel', { date: date }, function(data) {
