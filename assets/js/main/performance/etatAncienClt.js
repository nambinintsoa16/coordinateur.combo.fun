$(document).ready(function() {
    ...
    $('.client').on('click', function(e) {
        ...
        var parent = $(this).parent().parent();
        var Matricule_personnel = parent.children().first().text();
        $.post(base_url + 'Performance/listeNouveauxclientsss', { Matricule_personnel :Matricule_personnel }, function(data) {
...
;
    ...
    var parent = $(this).parent().parent();
    var Matricule_personnel = parent.children().first().text();   
    var link = base_url + "Performance/listeAnciensclients?Matricule_personnel=" + Matricule_personnel;
    Table.ajax.url(link);
    Table.ajax.reload();
