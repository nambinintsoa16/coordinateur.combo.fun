$(document).ready(function() {
  //  loding();
      table= $(".tableResult").DataTable({
        ...
        ajax: base_url + "Performance/etatNouveauxCltBody",
        language: {
    ...
    dataTableListe = $(".tableListe").DataTable({
        processing: true,
        searching: false,
        paging: false,
          language: {
    ...
    $('#valid_perf').on('click',function(event){
        ...
        let link = base_url + "Performance/etatNouveauxCltBody?date="+date_perf;
        table.ajax.url(link);
        table.ajax.reload();
    });
    function evenT(){
    ...
    $('.clientss').on('click', function(e) {
        e.preventDefault();
        var parent = $(this).parent().parent();
        var Matricule_personnel = parent.children().first().text();
        $.post(base_url + 'Performance/listeNouveauxclients', { Matricule_personnel :Matricule_personnel }, function(data) {
...
;
    ...
    var date = $('#date_perf').val();
    var link = base_url + "Performance/listeNouveauxclients?Matricule_personnel=" + Matricule_personnel+"&date="+date;
    dataTableListe.ajax.url(link);
    dataTableListe.ajax.reload();
