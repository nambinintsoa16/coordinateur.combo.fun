$(document).ready(function () {
    var Table = $(".table_reports").DataTable({
        ...
        initComplete: function (setting) {
            var mois = $('.dateR option:selected').val();
            $.post(base_url + 'Reel/dataWeek', { mois: mois }, function (data) {
                $('.caweek').children().eq(1).empty().append("");
                $('.caweek').children().eq(2).empty().append(data.tes);
                $('.caweek').children().eq(3).empty().append(data.te);
                $('.caweek').children().eq(5).empty().append(data.tesx);
                $('.caweek').children().eq(4).empty().append(data.t);
                $('.caweek').children().eq(6).empty().append(data.test);
            }, 'json');
            eventTable7();
            eventTables7();
            eventTabl7();
    ...
    $('.dateR').on('change', function (e) {
        e.preventDefault();
        var mois = $('.dateR option:selected').val();
        Table.ajax.url(base_url + "Reel/months/" + mois).load();
        $.post(base_url + 'Reel/dataWeek', { mois: mois }, function (data) {
            $('.caweek').children().eq(1).empty().append("");
            $('.caweek').children().eq(2).empty().append(data.tes);
            $('.caweek').children().eq(3).empty().append(data.te);
    ...
    function eventTable7() {
        $('.prod1').on('click', function (e) {
            ...
            $.post(base_url + 'Reel/produit', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTables7() {
        $('.prod2').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/produits', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTabl7() {
        $('.prod3').on('click', function (e) {
            ...
            var Prenom = parent.children().first().text();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/produi', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTableau7() {
        $('.prod4').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/produit4', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTableauxx7() {
        $('.prod5').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/produitTotal', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTotala() {
        $('.S1').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/totalpro1', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTotal2a() {
        $('.S2').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/totalpro2', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTotal3a() {
        $('.S3').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/totalpro3', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTotal4a() {
        $('.S4').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/totalpro4', { date: date, Prenom: Prenom, mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
    ...
    function eventTotal5a() {
        $('.Stotal').on('click', function (e) {
            ...
            var mois = $('.dateR option:selected').val();
            //var date = $('.date_collapse').text();
            $.post(base_url + 'Reel/totalpro5', { mois: mois }, function (data) {
                $.alert({
                    title: '',
                    content: data,
                });
